...
$srcPng = Join-Path $PSScriptRoot "meisterstein.png"
$workBmp = Join-Path $PSScriptRoot "isoulfragx.bmp"
$palFile = Join-Path $repo "blakston.pal"
$makebgf = Join-Path $repo "bin\\makebgf.exe"
$bgfName = "isoulfragx.bgf"
...
& $makebgf -o $bgfOut -n "master soul fragment" 1 $workBmp 1 1 1
Pop-Location

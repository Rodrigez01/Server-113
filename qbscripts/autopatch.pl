#!/usr/bin/perl
# ============================================================================
# autopatch.pl - GitHub Pull Request Automation für Meridian 59
# ============================================================================
# ZWECK: Automatisches Mergen von GitHub Pull Requests in Build-Branches
#
# VORAUSSETZUNGEN:
#   - Perl Module installieren: cpan install LWP::Simple Pithub Git::Repository
#   - GitHub Personal Access Token: set TOKEN=dein_github_token
...
#   Zeile 69-70:  GitHub User/Repo ändern (user => 'DeinUser', repo => 'DeinRepo')
#   Zeile 170-171: Gleiche Änderung für Error Status
#   Zeile 192-193: Gleiche Änderung für Success Status
# ============================================================================
...
foreach my $changelist (@changelists)
{
	...
	my $pullinfo = $p->get(user  => 'OpenMeridian105',    # ← HIER ÄNDERN
	...
	if (!$skip and $update)
	{
		...
		if ($output =~ /Automatic merge failed/)
		{
			...
			# ========== KONFIGURATION: GitHub Status Update (Error) ==========
			# TODO: Ändere User/Repo wie oben
		...
		else
		{
			...
			# ========== KONFIGURATION: GitHub Status Update (Success) ==========
			# TODO: Ändere User/Repo wie oben
			my $result   = $statuses->create(
				user  => 'OpenMeridian105',    # ← HIER ÄNDERN
				repo  => 'Meridian59',          # ← HIER ÄNDERN
